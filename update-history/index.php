...
<body class="update-history">
    ...
    <main>
        ...
        <div class="contents">
            ...
            <p>名前を「抹茶のひとやすみ」に変更! また、それに伴い 今までのよくわからなかった「Links」と「Contact」のページを削除!</p><p>その代わり、「About」と「おすすめ!」を追加。</p><p>「About」は、その名の通り管理人のアレコレを書くところ。</p><p>「おすすめ!」は、管理人のおすすめしたい"もの"や"ゲーム"を、好きに紹介するページ。</p><p>「そういえば、ドメイン『kyu-ka』だけど、『ひとやすみ』と若干違くないか」とか言わない。ドメイン作った直後にサイトの名前変えたんだもん。もう遅い。</p>
            <h2>Ver.13<span class="mini"> - 2021.9.23</span></h2>
            <p>訪問者数を計測するアクセスカウンターがない!? それっぽさが出てないって……? それなら対応してやろう……。</p><p>ということで、その過程でこのサイトはHTMLからPHPになった。動的から静的にして、またさらに動的にするっていう壮絶なWebサイト。んでも、不要なライブラリを読み込んでいない分、軽め。</p><p>そして、アクセスカウンターをついに設置することに成功! もちろん、PHPなんぞは知らんかったので、検索しまくってそれっぽいのを作った。</p><p>どこかのページにアクセスすると+1人として数える仕組み。ただし、更新しまくっても+1人としてされないように対策済み。セッション数とか訪問者数とかのイメージ。</p><p>5月に鯖を変えたときに、鯖側に残っていたカウント情報から訪問者数を抽出して、それを初期値に設定。そこからの計測なので推定値になるよ。</p><p>また、カウンター設置に伴い、階層をまるごと変更した。今まで「/about.html」だったのを「/about/」で表示できるようにした……などなど。</p>
